...
In the 1980s, a response to this financial and social imbalance emerged with the creation of time banking by Edgar Cahn in the United States.
However, this initiative faced structural limitations: record-keeping relied on human coordinators (which was time-consuming), the system lacked transparency, and the absence of digital interfaces limited its adoption.
